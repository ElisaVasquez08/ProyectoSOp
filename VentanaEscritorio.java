...
public class VentanaEscritorio extends JPanel {
    ...
    public Font fuenteLogin = new Font("Elephant", Font.BOLD, 50);
    public Font usuarioContraseña = new Font("Elephant", Font.BOLD, 30);
    public Font fuenteEtiquetas = new Font("Elephant", 0, 15);

    //ImageIcon fondoEscritorio = new ImageIcon(getClass().getResource("/imagenes/fondoEscritorio.jpg"));
    public JLabel labelEscritorioFondo = new JLabel();
    public JLabel etiquetaFondo = new JLabel();

    public JButton botonCrearUsuarios = new JButton("Crear usuario");
    public JButton botonCerrarSesion = new JButton("Cerrar Sesión");
    ...
    public JPanel panelLateralDerecho = new JPanel();
    public JPanel panelLateralIzquierdo = new JPanel();
    public JPanel panelSuperior = new JPanel();
    public JPanel panelInferior = new JPanel();

    public JLabel etiquetaNavegador = new JLabel("Navegador");
    public JLabel etiquetaEditorTexto = new JLabel("Editor de Texto");
    public JLabel etiquetaVisorImagenes = new JLabel("Visor de Imágenes");
    public JLabel etiquetaConsolaComandos = new JLabel("Consola de Comandos");
    public JLabel etiquetaReproductorMusical = new JLabel("Reproductor Musical");

    public JButton botonEditorTexto = new JButton();
    public JButton botonVisorImagenes = new JButton();
    public JButton botonConsolaComandos = new JButton();
    public JButton botonReproductorMusical = new JButton();

    public JButton botonEditorTextoSalir = new JButton();
    public JButton botonVisorImagenesSalir = new JButton();
    public JButton botonConsolaComandosSalir = new JButton();
    public JButton botonReproductorMusicalSalir = new JButton();

    public JLabel etiquetaFecha = new JLabel();
    ...
    public JLabel etiquetaFuente = new JLabel("Fuente");
    public String tipoFuentes[];
    public JComboBox comboFuenteEditor;

    public JLabel etiquetaTamañoLetra = new JLabel("Tamaño de letra");
    ...
    public JLabel etiquetaColorLetra = new JLabel("Color de la letra");
    public String colorLetra[] = {"Negro", "Gris Claro", "Gris", "Rojo", "Verde", "Azul", "Amarillo", "Celeste", "Magenta", "Blanco", "Gris Oscuro", "Anaranjado", "Rosado"};
    public JComboBox comboColorLetra = new JComboBox(colorLetra);

    public JLabel etiquetaFondoColor = new JLabel("Color de Fondo");
    public String colorFondo[] = {"Blanco", "Gris Claro", "Gris", "Rojo", "Verde", "Azul", "Amarillo", "Celeste", "Magenta", "Gris Oscuro", "Negro", "Anaranjado", "Rosado"};
    public JComboBox comboColorFondo = new JComboBox(colorFondo);

    public JLabel etiquetaEstilo = new JLabel("Estilo");
    public String estilo[] = {"Normal", "Negrita", "Itálica"};
    ...
    public VentanaEscritorio() {
        ...
        String fecha = "Fecha: " + dia + "/" + mes + "/2023";
        etiquetaFecha.setText(fecha);
        etiquetaFecha.setForeground(Color.WHITE);
        etiquetaFecha.setBounds(55, 0, 300, 30);

        panelLateralDerecho.setBackground(Color.RED);
        panelLateralIzquierdo.setBackground(Color.RED);
        ...
        try {
            Image imagenEscritorio = ImageIO.read(getClass().getResource("/imagenes/fondoEscritorio.jpg"));
            labelEscritorioFondo.setIcon(new ImageIcon(imagenEscritorio.getScaledInstance(1170-200, 630, java.awt.Image.SCALE_SMOOTH)));
        } catch (IOException ex) {
            Logger.getLogger(VentanaEscritorio.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            Image imagenVisorImagenes = ImageIO.read(getClass().getResource("/imagenes/visorImagenes.png"));
        ...
        try {
            Image imagenReproductorMusical = ImageIO.read(getClass().getResource("/imagenes/reproductorMusical.png"));
        ...
        labelEscritorioFondo.setBounds(200, 30, 1170-200, 630);
        labelEscritorioFondo.setOpaque(false);
        add(labelEscritorioFondo, BorderLayout.SOUTH);
